...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='loadS', choices=['loadS', 'loadT', '2017', '2018', '2019', '2020'], help='name of dataset')
parser.add_argument('--root_path', type=str, default='./datasets/load-data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='loadS.csv', help='location of the data file')
parser.add_argument('--features', type=str, default='M', choices=['S', 'M'], help='features S is univariate, M is multivariate')
parser.add_argument('--target', type=str, default='EL', help='target feature')
parser.add_argument('--freq', type=str, default='h', help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
parser.add_argument('--checkpoints', type=str, default='exp/load_checkpoints/', help='location of model checkpoints')
...
data_parser = {
    'loadS': {'data': 'loadS.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]},
    'loadT': {'data': 'loadT.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]},
    '2017': {'data': '2017.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]},
    '2018': {'data': '2018.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]},
    '2019': {'data': '2019.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]},
    '2020': {'data': '2020.csv', 'M': [10, 10, 10], 'S': [1, 1, 1], 'MS': [10, 10, 1]}
}
